...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">Bolivia Tech Hub</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <br><br><br><br><br><br><a class="nav-link" href="{{route('eventos.index')}}">
        ...
        <li class="nav-item">
                  ...
                  <ul class="navbar-nav ml-auto">  <!-- Authentication Links -->
                    @if (Auth::guest())
                        ...
                        <ul class="nav-item ml-auto"><a href="{{ url('/register') }}"><b>Registrar +</b></a></ul>
                   </ul> @else
                        <li class="dropdown">
